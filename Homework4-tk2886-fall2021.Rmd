...
knitr::include_graphics("Problem1.JPG")
```
...
```{r echo=FALSE, fig.align="center", out.width = '50%'}
knitr::include_graphics("problem2bTS.jpeg")
```
...
```{r echo=FALSE, fig.align="center", out.width = '50%'}
knitr::include_graphics("problem2bcv.jpeg")
```

**Interpretation in context to our problem:**
Our F-statistics (19.53) is bigger than our critical value (5.72), we reject the null hypothesis. At 0.01 significance level, we reject the null hypothesis and conclude that at least two of mean PTSD scores from the three type of crash groups are different. 
...
**Ho:** Subject's Relapse and anti-depressant drug assigned to are independent (p1=p2=p3)

**Ha:** Subject's Relapse and anti-depressant drug assigned to are associated/dependent 

**Test Statistics:**
The test statistic is: `r test_statistic`

**Critical Value:**
The critical value is: `r critical_value` -> **critical value was obtained from R-code above qchisq().**

```{r echo=FALSE, fig.align="center", out.width = '50%'}
knitr::include_graphics("problem3cCV.jpeg")
```
